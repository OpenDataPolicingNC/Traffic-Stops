...
class GrouperTestCase(TestCase):
    def test_single_item_group(self):
        ...
        stops.add(2010, race1=10)
        stops.add(2010, race2=10)
        stops.add(2011, race1=5)
        stops.add(2011, race2=5)
    ...
    def test_pair_item_group(self):
        ...
        stops.add('Checkpoint', 2010, race1=10)
        stops.add('Checkpoint', 2010, race2=10)
        stops.add('Checkpoint', 2011, race1=5)
        stops.add('Checkpoint', 2011, race2=5)
