...
-- import stops
BEGIN;
COPY stops_stop FROM '/home/shapiromatron/Desktop/shapiromatron/dev/csv/STOP.csv' WITH
    DELIMITER ','
    NULL AS ''
    CSV HEADER
...
-- import persons
BEGIN;
COPY stops_person FROM '/home/shapiromatron/Desktop/shapiromatron/dev/csv/PERSON.csv' WITH
    DELIMITER ','
    NULL AS ''
    CSV HEADER
