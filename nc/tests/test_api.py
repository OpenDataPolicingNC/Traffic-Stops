...
class AgencyTests(APITestCase):
    ...
    def test_stops_by_reason(self):
        ...
        self.assertEqual(searches[0][race_label], 0)
        self.assertEqual(searches[0]['hispanic'], 1)
        ...
        self.assertEqual(stops[0][race_label], 1)
        self.assertEqual(stops[0]['hispanic'], 1)
    ...
    def test_searches(self):
        ...
        agency = factories.AgencyFactory()
        p1 = factories.PersonFactory(ethnicity='N', stop__agency=agency, stop__year=2015)
        s1 = factories.SearchFactory(person=p1, stop=p1.stop)
        p2 = factories.PersonFactory(ethnicity='H', stop__agency=agency, stop__year=2016)
