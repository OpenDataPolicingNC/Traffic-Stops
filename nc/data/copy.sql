...
-- -- populate nc_agency lookup table, preserving agency id from CSV

COPY nc_agency (id, name, census_profile_id) from :'nc_csv_table' WITH
    DELIMITER ','
    CSV HEADER
    FORCE NOT NULL census_profile_id;
