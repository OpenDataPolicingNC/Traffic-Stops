...
function rebuild(options) {
  ...
  browserifyTask({
    development: options.development,
    src: './traffic_stops/static/js/index.js',
    dest: './traffic_stops/static/js/'
  });

  cssTask({
    development: options.development,
    src: './traffic_stops/static/less/index.less',
    watch: './traffic_stops/static/less/**/*.less',
    dest: './traffic_stops/static/css/'
  });
}
